...
export default class ItemsEditor extends React.PureComponent {
	editor = null;
		...
		return (
			<ItemsContainer id="editor">
				...
				<ItemsTextArea
					...
					autoCapitalize="off"
					spellCheck="false"
					defaultValue={this.props.itemsJSON}
					onChange={this.handleTextChange}
				/>
				<OrderedList id="directions">
					<li>
						<button onClick={this.handleCopy}>Copy</button> the code
					...
					<li>
						...
						left, <button onClick={this.handleDelete}>delete</button> all
